...
import bt3.Client.ClientListener;
...
public class Server {
    ...
    public static List<ClientListener> clients = new CopyOnWriteArrayList<>();
    ...
    public Server() {
        ...
        try {
            serverSocket = new ServerSocket(Integer.parseInt(config.getConfig("port")), Integer.parseInt(config.getConfig("clients")));
            startServer();
            acceptConnection();
    ...
    public void acceptConnection() throws IOException {
        ...
        while (true) {
            ...
            try {
                ...
                ClientListener clientListener = new ClientListener(clientSocket, queue);
